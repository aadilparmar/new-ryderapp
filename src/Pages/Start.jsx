    ...
    <div>
      <div className="bg-cover bg-center bg-[url(/assets/home-bg.jpeg)]  h-screen pt-8 flex justify-between flex-col w-full bg-red-400">
        ...
        <div className="bg-white pb-7 py-4 px-4">
          ...
          <Link to='/login'className="flex items-center justify-center w-full bg-black text-white py-3 rounded mt-5">Continue<i className="ri-arrow-right-long-line"></i></Link>
        </div>
      </div>
    </div>
  );
